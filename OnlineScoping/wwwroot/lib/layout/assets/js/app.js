    ...
    var toggleFunction = {
        sidebar: function($recentSubmenu) {
            $('.sidebarCollapse').on('click', function (sidebar) {
                ...
                var get_CompactSubmenuShow = document.querySelector('#compact_submenuSidebar');
                var get_overlay = document.querySelector('.overlay');
                var get_mainContainer = document.querySelector('.main-container')
        ...
        onSidebarClick: function() {
            ...
            for (var i = 0; i < getMenu.length; i++) {
                getMenu[i].addEventListener('click', function() {
                    ...
                    var getHref = this.querySelectorAll('.menu-toggle')[0].getAttribute('href');
                    var getElement = document.querySelectorAll('#compact_submenuSidebar > ' + getHref)[0];
                    var getMenuShowElement = document.querySelector('.menu.show');
                    var getCompactSubmenu = document.querySelector('#compact_submenuSidebar');
                    var getOverlayElement = document.querySelector('.overlay');
                    var getElementActiveClass = document.querySelector('#compact_submenuSidebar > .show');
