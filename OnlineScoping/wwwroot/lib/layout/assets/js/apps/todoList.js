...
// Validation Process
  ...
  var getTaskTitleInput = document.getElementById('task');

  getTaskTitleInput.addEventListener('input', function() {

     var getTaskTitleInputValue = this.value;
  ...
  var getTaskDescriptionInput = document.getElementById('taskdescription');

  getTaskDescriptionInput.addEventListener('input', function() {

    var getTaskDescriptionInputValue = this.value;
