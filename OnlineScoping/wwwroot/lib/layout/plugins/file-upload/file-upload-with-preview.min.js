var FileUploadWithPreview = function () {
    ...
    var A, e = (function (A) {
        var e = function (A) {
            ...
            function r(A, e, t, g) {
                ...
                return i._invoke = function (A, e, t) {
                    ...
                    return function (n, i) {
                        ...
                        {
                            var B = t.delegate; if (B)
                            {
                                var E = S(B, t); if (E)
                                { if (E === s) continue; return E }
                            } if ("next" === t.method) t.sent = t._sent = t.arg;
                            else if ("throw" === t.method) {
                                if (g === o) throw g = a,
                                    t.arg; t.dispatchException(t.arg)
                            } else "return" === t.method && t.abrupt("return", t.arg);
                            g = Q;
                            var r = C(A, e, t); if ("normal" === r.type) {
            ...
            function C(A, e, t) {
                try { return { type: "normal", arg: A.call(e, t) } } catch (A) { return { type: "throw", arg: A } }
            } A.wrap = r;
